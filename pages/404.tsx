...
const CustomError404 = () => {
  return (
    <>
      <Layout title="Pagina non trovata | I Soli di Claudio">
            ...
            <div className="container col-xxl-8">
                <div className="row flex-lg-row-reverse align-items-center g-5">
                    <div className="col-10 col-sm-8 col-lg-5 justify-content-center my-auto mx-auto pt-5">
                        <img src="/500_mascotte.png" className="d-block img-fluid ml-4 error_page_img" alt="Page Not Found Error" width="1200" height="900" loading="lazy" />
                    </div>
                    <div className="col-lg-6">
                        <h1 className="display-5 text-center fw-bold lh-1 mb-5">Pagina non trovata</h1>
                        <p className="lead">Potresti aver utilizzato un link corrotto o che non esiste in questo sito, per favore controlla di aver digitato un URL corretto.</p>
                        <p className="lead">
